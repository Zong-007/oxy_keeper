...
// เขียนหัวข้อคอลัมน์
fputcsv($output, array('BPM', 'Spo2', 'day', 'Status')); // เปลี่ยนชื่อคอลัมน์ตามฐานข้อมูลของคุณ

// ดึงข้อมูลจากฐานข้อมูล
$sql = "SELECT BPM, Spo2, day, Status FROM oxy_table"; // แก้ไขตามตารางในฐานข้อมูลของคุณ
